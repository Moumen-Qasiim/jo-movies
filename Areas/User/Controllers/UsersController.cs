...
namespace JO_MOVIES.Areas.User.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,profileURL,Name,Email,Password")] JO_MOVIES.Models.User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,profileURL,Name,Email,Password")] JO_MOVIES.Models.User user)
        {
            if (id != user.Id)
            {
                return NotFound();
